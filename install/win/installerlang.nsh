...
LangString NAME_SecMusic ${LANG_ROMANIAN} "Muzica DOS"
LangString DESC_SecMusic ${LANG_ROMANIAN} "Înregistrări muzică în Adlib/SoundBlaster. Repară problemele de rulare în Windows. (necesită o conexiune la internet)"
...
LangString PAGE_UfoFolder ${LANG_POLISH} "${GAME_NAME} wymaga kopii gry UFO: Enemy Unknown / X-COM: UFO Defense na dysku. Możesz pominąć ten krok, jeśli aktualizujesz już istniejącą instalację.$\n$\nInstalator skopiuje potrzebne pliki z poniższego folderu. Aby zmienić folder źródłowy, naciśnij przycisk Przeglądaj i wybierz inny folder. Naciśnij Dalej, aby kontynuować."
LangString PAGE_UfoFolder_TITLE ${LANG_POLISH} "Wskaż lokalizację gry X-COM 1"
LangString PAGE_UfoFolder_SUBTITLE ${LANG_POLISH} "Wybierz folder, w którym zainstalowana jest gra X-COM 1."
LangString DEST_UfoFolder ${LANG_POLISH} "Folder X-COM 1"
...
LangString DESC_SecPatch ${LANG_POLISH} "Naprawia błędy danych gry X-COM 1. Zalecane przy pierwszej instalacji. (Wymaga połączenia z internetem.)"
LangString NAME_SecMusic ${LANG_POLISH} "Muzyka DOS"
LangString DESC_SecMusic ${LANG_POLISH} "Muzyka w wersji Adlib/SoundBlaster. Naprawia błędy odtwarzania muzyki przez system Windows. (Wymaga połączenia z internetem.)"
...
LangString NAME_UnData ${LANG_POLISH} "Usuń pliki gry X-COM"
LangString DESC_UnData ${LANG_POLISH} "Usuń wszystkie dane gry ${GAME_NAME}, włącznie z modami i plikami gry X-COM. Zalecane dla czystej reinstalacji."
...
LangString WARN_UFOMissing ${LANG_POLISH} "Nie znaleziono gry X-COM 1 w tym folderze. Do właściwego działania, ${GAME_NAME} wymaga prawidłowo zainstalowanej gry X-COM. Kontynuować?"
LangString WARN_XCUDetected ${LANG_POLISH} "Wykryto XcomUtil. Gra ${GAME_NAME} nie jest kompatybilna z XcomUtil, który może spowodować niewłaściwe jej działanie. Kontynuować?"
...
LangString DESC_SecMusic ${LANG_GERMAN} "Adlib/SoundBlaster Musikaufnahme. Repariert Probleme bei der Wiedergabe bei Windows. (Braucht eine Verbindung zum Internet.)"
...
LangString NAME_SecMusic ${LANG_PORTUGUESEBR} "Musica do DOS"
LangString DESC_SecMusic ${LANG_PORTUGUESEBR} "Gravação de músicas Adlib/SoundBlaster. Corrige problemas de reprodução no Windows. (requer uma conexão com a internet)"
...
LangString NAME_SecMusic ${LANG_RUSSIAN} "DOS-музыка"
LangString DESC_SecMusic ${LANG_RUSSIAN} "Музыка, записанная для Adlib/SoundBlaster. Исправляет проблемы воспроизведения для Windows (требуется подключение к Интернету)."
