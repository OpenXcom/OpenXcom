...
struct BattleAction
{
	...
	BattleAction() : type(BA_NONE), actor(nullptr), weapon(nullptr), TU(0), targeting(false), value(0), strafe(false), run(false), diff(0), autoShotCounter(0), cameraPosition(0, 0, -1), desperate(false), finalFacing(-1), finalAction(false), number(0) { }
};
