...
void ManufactureInfoState::buildUi()
{
	...
	_txtAvailableEngineer = new Text(200, tr(9,"TextSmallH"), 16, 55);
	_txtAvailableSpace = new Text(200, tr(9,"TextSmallH"), 16, 65);
	_txtAllocatedEngineer = new Text(112, 32, 16, 75);
	_txtUnitToProduce = new Text(104, 32, 168, 75);
	_txtEngineerUp = new Text(90, tr(9,"TextSmallH"), 40, tr(113,"ManufactureInfoEngineerUpY"));
	_txtEngineerDown = new Text(90, tr(9,"TextSmallH"), 40, tr(133,"ManufactureInfoEngineerDownY"));
	_txtUnitUp = new Text(90, tr(9,"TextSmallH"), 192, tr(113,"ManufactureInfoUnitUpY"));
	_txtUnitDown = new Text(90, tr(9,"TextSmallH"), 192, tr(133,"ManufactureInfoUnitDownY"));
...
void ManufactureInfoState::setAssignedEngineer()
{
	...
	s4 << L">\x01";
	if (_production->getInfiniteAmount()) s4 << L'\u221E'; /* Language::utf8ToWstr("¡Ä"); */
