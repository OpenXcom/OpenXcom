...
BaseInfoState::BaseInfoState(Game *game, Base *base, BasescapeState *state) : State(game), _base(base), _state(state)
{
	...
	_btnOk = new TextButton(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 30, 14, 10, 180);
	_btnTransfers = new TextButton(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 80, 14, 46, 180);
	_btnStores = new TextButton(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 80, 14, 132, 180);
	_btnMonthlyCosts = new TextButton(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 92, 14, 218, 180);
	_edtBase = new TextEdit(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 136, 16, 8, 8);

	_txtPersonnel = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 300, 9, 8, 30);
	_txtSoldiers = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 114, 9, 8, 41);
	_numSoldiers = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 40, 9, 126, 41);
	_barSoldiers = new Bar(150, 5, 165, 43);
	_txtEngineers = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 114, 9, 8, 51);
	_numEngineers = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 40, 9, 126, 51);
	_barEngineers = new Bar(150, 5, 165, 53);
	_txtScientists = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 114, 9, 8, 61);
	_numScientists = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 40, 9, 126, 61);
	_barScientists = new Bar(150, 5, 165, 63);

	_txtSpace = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 300, 9, 8, 72);
	_txtQuarters = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 114, 9, 8, 83);
	_numQuarters = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 40, 9, 126, 83);
	_barQuarters = new Bar(150, 5, 165, 85);
	_txtStores = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 114, 9, 8, 93);
	_numStores = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 40, 9, 126, 93);
	_barStores = new Bar(150, 5, 165, 95);
	_txtLaboratories = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 114, 9, 8, 103);
	_numLaboratories = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 40, 9, 126, 103);
	_barLaboratories = new Bar(150, 5, 165, 105);
	_txtWorkshops = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 114, 9, 8, 113);
	_numWorkshops = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 40, 9, 126, 113);
	_barWorkshops = new Bar(150, 5, 165, 115);
	_txtHangars = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 114, 9, 8, 123);
	_numHangars = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 40, 9, 126, 123);
	_barHangars = new Bar(150, 5, 165, 125);

	_txtDefence = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 114, 9, 8, 138);
	_numDefence = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 40, 9, 126, 138);
	_barDefence = new Bar(150, 5, 165, 140);
	_txtShortRange = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 130, 9, 8, 153);
	_numShortRange = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 40, 9, 126, 153);
	_barShortRange = new Bar(150, 5, 165, 155);
	_txtLongRange = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 130, 9, 8, 163);
	_numLongRange = new Text(_game->getResourcePack()->getFont("BIGLETS.DAT"), _game->getResourcePack()->getFont("SMALLSET.DAT"), 40, 9, 126, 163);
