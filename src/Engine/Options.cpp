...
void create()
{
	...
	_info.push_back(OptionInfo("maxFrameSkip", &maxFrameSkip, 0, "STR_MAXFRAMESKIP", "STR_GENERAL"));
	...
	_info.push_back(OptionInfo("battleScrollDragInvert", &battleScrollDragInvert, false, "STR_BATTLESCROLLDRAGINVERT", "STR_GENERAL")); // true drags away from the cursor, false drags towards (like a grab)
	...
	_info.push_back(OptionInfo("psiStrengthEval", &psiStrengthEval, false, "STR_PSISTRENGTHEVAL", "STR_BATTLESCAPE"));
