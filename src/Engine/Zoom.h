...
class Zoom
{
	...
	static void flipWithZoom(SDL_Surface *src, SDL_Surface *dst, SDL_Window *window, int topBlackBand, int bottomBlackBand, int leftBlackBand, int rightBlackBand, OpenGL *glOut);
