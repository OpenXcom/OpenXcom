 ...
 */
Craft::Craft(RuleCraft *rules, Base *base, int id) : MovingTarget(), _rules(rules), _base(base), _id(0), _fuel(0), _damage(0), _patrolTime(0), _weapons(), _status("STR_READY"), _lowFuel(false), _inBattlescape(false)
{
