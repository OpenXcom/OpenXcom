 ...
 */
size_t Mod::getSpriteOffset(size_t sprite, const std::string& set) const
{
...
*/
size_t Mod::getSoundOffset(size_t sound, const std::string& set) const
{
	SoundSet *ss = getSoundSet(set);
