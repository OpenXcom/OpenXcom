...
OptionsBattlescapeState::OptionsBattlescapeState(OptionsOrigin origin) : OptionsBaseState(origin)
{
	...
	_btnArrows = new ToggleTextButton(104, _game->getLanguage()->getWindowValue(16, "OptionsBattleArrowsH"), 94, 110);
	_btnTuCost = new ToggleTextButton(104, _game->getLanguage()->getWindowValue(16, "OptionsBattleTuCostH"), 94, _game->getLanguage()->getWindowValue(128, "OptionsBattleTuCostY"));

	_txtOptions = new Text(114, 9, 206, 100);
	_btnTooltips = new ToggleTextButton(104, _game->getLanguage()->getWindowValue(16, "OptionsBattleTooltipsH"), 206, 110);
	_btnDeaths = new ToggleTextButton(104, _game->getLanguage()->getWindowValue(16, "OptionsBattleDeathsH"), 206, _game->getLanguage()->getWindowValue(128, "OptionsBattleDeathsY"));
