 ...
 */
SaveState::SaveState( OptionsOrigin origin) : SavedGameState(origin, 1), _selected(L""), _previousSelectedRow(-1), _selectedRow(-1)
{
	// Create objects
 ...
 */
SaveState::SaveState( OptionsOrigin origin, bool showMsg) : SavedGameState(origin, 1, showMsg)
{
    _game->getSavedGame()->setName(L"autosave");
	quickSave("autosave");
}
