...
TestState::TestState()
{
	...
	_set = _game->getRuleset()->getSurfaceSet("BASEBITS.PCK");
	_set->getFrame(1);
	...
	//_game->getRuleset()->getPalette("PAL_GEOSCAPE")->savePal("../../../Geoscape.pal");
	//_game->getRuleset()->getPalette("PAL_BASESCAPE")->savePal("../../../Basescape.pal");
	//_game->getRuleset()->getPalette("PAL_UFOPAEDIA")->savePal("../../../Ufopaedia.pal");
	//_game->getRuleset()->getPalette("PAL_BATTLESCAPE")->savePal("../../../Battlescape.pal");

	//_game->getRuleset()->getFont("FONT_BIG")->fix("../../../Big.bmp", 256);
	//_game->getRuleset()->getFont("FONT_SMALL")->fix("../../../Small.bmp", 128);
}
