...
//  ruleTerrain->getMapDataSets()->push_back(getMapDataSet("U_PODS"));
	...
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_00",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_01",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_02",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_03",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_04",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_05",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_06",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_07",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_08",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_09",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_10",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_11",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_12",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_13",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_14",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_15",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_16",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_17",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_18",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_19",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(xbase,"XBASE_20",10,10,MT_DIRT));
	...
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_00",20,20,MT_UBASECOMM));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_01",20,20,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_02",20,20,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_03",20,20,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_04",10,10,MT_XCOMSPAWN));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_05",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_06",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_07",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_08",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_09",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_10",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_11",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_12",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_13",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_14",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(ubase,"UBASE_15",20,20,MT_FINALCOMM));
