...
XcomRuleset::XcomRuleset() : Ruleset()
{
	...
	american->addMaleName(L"Austin");
	american->addMaleName(L"Calvin");
	american->addMaleName(L"Carl");
	american->addMaleName(L"Clarence");
	american->addMaleName(L"Donald");
	american->addMaleName(L"Dwight");
	american->addMaleName(L"Ed");
	american->addMaleName(L"Kevin");
	american->addMaleName(L"Lester");
	american->addMaleName(L"Mark");
	american->addMaleName(L"Oscar");
	american->addMaleName(L"Samuel");
	american->addMaleName(L"Spencer");
	american->addMaleName(L"Tom");
	american->addMaleName(L"Virgil");
	american->addFemaleName(L"Barbara");
	american->addFemaleName(L"Catherine");
	american->addFemaleName(L"Evelyn");
	american->addFemaleName(L"Patricia");
	american->addFemaleName(L"Sigourney");
	american->addLastName(L"Bradley");
	american->addLastName(L"Bryant");
	american->addLastName(L"Carr");
	american->addLastName(L"Crossett");
	american->addLastName(L"Dodge");
	american->addLastName(L"Gallagher");
	american->addLastName(L"Homburger");
	american->addLastName(L"Horton");
	american->addLastName(L"Hudson");
	american->addLastName(L"Johnson");
	american->addLastName(L"Kemp");
	american->addLastName(L"King");
	american->addLastName(L"McNeil");
	american->addLastName(L"Miller");
	american->addLastName(L"Mitchell");
	american->addLastName(L"Nash");
	american->addLastName(L"Stephens");
	american->addLastName(L"Stoddard");
	american->addLastName(L"Thompson");
	american->addLastName(L"Webb");
	_names.push_back(american);

	SoldierNamePool *british = new SoldierNamePool();
	british->addMaleName(L"Adam");
	british->addMaleName(L"Alan");
	british->addMaleName(L"Arthur");
	british->addMaleName(L"Brett");
	british->addMaleName(L"Damien");
	british->addMaleName(L"David");
	british->addMaleName(L"Frank");
	british->addMaleName(L"James");
	british->addMaleName(L"John");
	british->addMaleName(L"Michael");
	british->addMaleName(L"Neil");
	british->addMaleName(L"Patrick");
	british->addMaleName(L"Paul");
	british->addMaleName(L"Robert");
	british->addMaleName(L"Scott");
	british->addFemaleName(L"Andrea");
	british->addFemaleName(L"Helen");
	british->addFemaleName(L"Jane");
	british->addFemaleName(L"Maria");
	british->addFemaleName(L"Sarah");
	british->addLastName(L"Bailey");
	british->addLastName(L"Blake");
	british->addLastName(L"Davies");
	british->addLastName(L"Day");
	british->addLastName(L"Evans");
	british->addLastName(L"Hill");
	british->addLastName(L"Jones");
	british->addLastName(L"Jonlan");
	british->addLastName(L"Martin");
	british->addLastName(L"Parker");
	british->addLastName(L"Pearce");
	british->addLastName(L"Reynolds");
	british->addLastName(L"Robinson");
	british->addLastName(L"Sharpe");
	british->addLastName(L"Smith");
	british->addLastName(L"Stewart");
	british->addLastName(L"Taylor");
	british->addLastName(L"Watson");
	british->addLastName(L"White");
	british->addLastName(L"Wright");
	_names.push_back(british);

	SoldierNamePool *french = new SoldierNamePool();
	french->addMaleName(L"Armand");
	french->addMaleName(L"Bernard");
	french->addMaleName(L"Claude");
	french->addMaleName(L"Emile");
	french->addMaleName(L"Gaston");
	french->addMaleName(L"Gerard");
	french->addMaleName(L"Henri");
	french->addMaleName(L"Jacques");
	french->addMaleName(L"Jean");
	french->addMaleName(L"Leon");
	french->addMaleName(L"Louis");
	french->addMaleName(L"Marc");
	french->addMaleName(L"Marcel");
	french->addMaleName(L"Pierre");
	french->addMaleName(L"Rene");
	french->addFemaleName(L"Danielle");
	french->addFemaleName(L"Jacqueline");
	french->addFemaleName(L"Marielle");
	french->addFemaleName(L"Micheline");
	french->addFemaleName(L"Sylvie");
	french->addLastName(L"Bouissou");
	french->addLastName(L"Bouton");
	french->addLastName(L"Buchard");
	french->addLastName(L"Coicard");
	french->addLastName(L"Collignon");
	french->addLastName(L"Cuvelier");
	french->addLastName(L"Dagallier");
	french->addLastName(L"Dreyfus");
	french->addLastName(L"Dujardin");
	french->addLastName(L"Gaudin");
	french->addLastName(L"Gautier");
	french->addLastName(L"Gressier");
	french->addLastName(L"Guerin");
	french->addLastName(L"Laroyenne");
	french->addLastName(L"Lecointe");
	french->addLastName(L"Lefevre");
	french->addLastName(L"Luget");
	french->addLastName(L"Marcelle");
	french->addLastName(L"Pecheux");
	french->addLastName(L"Revenu");
	_names.push_back(french);

	SoldierNamePool *german = new SoldierNamePool();
	german->addMaleName(L"Dieter");
	german->addMaleName(L"Franz");
	german->addMaleName(L"Gerhard");
	german->addMaleName(L"Gunter");
	german->addMaleName(L"Hans");
	german->addMaleName(L"Jurgen");
	german->addMaleName(L"Klaus");
	german->addMaleName(L"Manfred");
	german->addMaleName(L"Matthias");
	german->addMaleName(L"Otto");
	german->addMaleName(L"Rudi");
	german->addMaleName(L"Siegfried");
	german->addMaleName(L"Stefan");
	german->addMaleName(L"Werner");
	german->addMaleName(L"Wolfgang");
	german->addFemaleName(L"Christel");
	german->addFemaleName(L"Gudrun");
	german->addFemaleName(L"Helga");
	german->addFemaleName(L"Karin");
	german->addFemaleName(L"Uta");
	german->addLastName(L"Berger");
	german->addLastName(L"Brehme");
	german->addLastName(L"Esser");
	german->addLastName(L"Faerber");
	german->addLastName(L"Geisler");
	german->addLastName(L"Gunkel");
	german->addLastName(L"Hafner");
	german->addLastName(L"Heinsch");
	german->addLastName(L"Keller");
	german->addLastName(L"Krause");
	german->addLastName(L"Mederow");
	german->addLastName(L"Meyer");
	german->addLastName(L"Richter");
	german->addLastName(L"Schultz");
	german->addLastName(L"Seidler");
	german->addLastName(L"Steinbach");
	german->addLastName(L"Ulbricht");
	german->addLastName(L"Unger");
	german->addLastName(L"Vogel");
	german->addLastName(L"Zander");
	_names.push_back(german);

	SoldierNamePool *japanese = new SoldierNamePool();
	japanese->addMaleName(L"Akinori");
	japanese->addMaleName(L"Isao");
	japanese->addMaleName(L"Jungo");
	japanese->addMaleName(L"Kenji");
	japanese->addMaleName(L"Masaharu");
	japanese->addMaleName(L"Masanori");
	japanese->addMaleName(L"Naohiro");
	japanese->addMaleName(L"Shigeo");
	japanese->addMaleName(L"Shigeru");
	japanese->addMaleName(L"Shuji");
	japanese->addMaleName(L"Tatsuo");
	japanese->addMaleName(L"Toshio");
	japanese->addMaleName(L"Yasuaki");
	japanese->addMaleName(L"Yataka");
	japanese->addMaleName(L"Yuzo");
	japanese->addFemaleName(L"Mariko");
	japanese->addFemaleName(L"Michiko");
	japanese->addFemaleName(L"Sata");
	japanese->addFemaleName(L"Sumie");
	japanese->addFemaleName(L"Yoko");
	japanese->addLastName(L"Akira");
	japanese->addLastName(L"Fujimoto");
	japanese->addLastName(L"Ishii");
	japanese->addLastName(L"Iwahara");
	japanese->addLastName(L"Iwasaki");
	japanese->addLastName(L"Kojima");
	japanese->addLastName(L"Koyama");
	japanese->addLastName(L"Matsumara");
	japanese->addLastName(L"Morita");
	japanese->addLastName(L"Noguchi");
	japanese->addLastName(L"Okabe");
	japanese->addLastName(L"Okamoto");
	japanese->addLastName(L"Sato");
	japanese->addLastName(L"Shimaoka");
	japanese->addLastName(L"Shoji");
	japanese->addLastName(L"Tanida");
	japanese->addLastName(L"Tanikawa");
	japanese->addLastName(L"Yamanaka");
	japanese->addLastName(L"Yamashita");
	japanese->addLastName(L"Yamazaki");
	_names.push_back(japanese);

	SoldierNamePool *russian = new SoldierNamePool();
	russian->addMaleName(L"Anatoly");
	russian->addMaleName(L"Andrei");
	russian->addMaleName(L"Boris");
	russian->addMaleName(L"Dmitriy");
	russian->addMaleName(L"Gennadi");
	russian->addMaleName(L"Grigoriy");
	russian->addMaleName(L"Igor");
	russian->addMaleName(L"Ivan");
	russian->addMaleName(L"Leonid");
	russian->addMaleName(L"Mikhail");
	russian->addMaleName(L"Nikolai");
	russian->addMaleName(L"Sergei");
	russian->addMaleName(L"Victor");
	russian->addMaleName(L"Vladimir");
	russian->addMaleName(L"Yuri");
	russian->addFemaleName(L"Astra");
	russian->addFemaleName(L"Galina");
	russian->addFemaleName(L"Lyudmila");
	russian->addFemaleName(L"Olga");
	russian->addFemaleName(L"Tatyana");
	russian->addLastName(L"Andianov");
	russian->addLastName(L"Belov");
	russian->addLastName(L"Chukarin");
	russian->addLastName(L"Gorokhova");
	russian->addLastName(L"Kolotov");
	russian->addLastName(L"Korkia");
	russian->addLastName(L"Likhachev");
	russian->addLastName(L"Maleev");
	russian->addLastName(L"Mikhailov");
	russian->addLastName(L"Petrov");
	russian->addLastName(L"Ragulin");
	russian->addLastName(L"Romanov");
	russian->addLastName(L"Samusenko");
	russian->addLastName(L"Scharov");
	russian->addLastName(L"Shadrin");
	russian->addLastName(L"Shalimov");
	russian->addLastName(L"Torban");
	russian->addLastName(L"Voronin");
	russian->addLastName(L"Yakubik");
	russian->addLastName(L"Zhdanovich");
