...
XcomRuleset::XcomRuleset() : Ruleset()
{
	...
	ruleTerrain->getMapBlocks()->push_back(new MapBlock(ruleTerrain,"UFO1A",10,10,MT_DEFAULT));
...
//  ruleTerrain->getMapDataSets()->push_back(getMapDataSet("U_PODS"));
	ruleTerrain->getMapBlocks()->push_back(new MapBlock(ruleTerrain,"UFO_110",10,10,MT_DEFAULT));
	...
	ruleTerrain->getMapDataSets()->push_back(getMapDataSet("U_WALL02"));
	ruleTerrain->getMapDataSets()->push_back(getMapDataSet("U_BITS"));
	ruleTerrain->getMapBlocks()->push_back(new MapBlock(ruleTerrain,"UFO_120",20,20,MT_DEFAULT));
	...
	ruleTerrain->getMapDataSets()->push_back(getMapDataSet("U_DISEC2"));
	ruleTerrain->getMapDataSets()->push_back(getMapDataSet("U_BITS"));
	ruleTerrain->getMapBlocks()->push_back(new MapBlock(ruleTerrain,"UFO_130",20,20,MT_DEFAULT));
	...
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA00",10,10,MT_LANDINGZONE));
	//culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA0B",10,10,false));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA01",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA02",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA03",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA04",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA05",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA06",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA07",10,10,MT_LANDINGZONE));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA08",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA09",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA10",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA11",10,10,MT_LANDINGZONE));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA12",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA13",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA14",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA15",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA16",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA17",10,10,MT_DEFAULT));
	culta->getMapBlocks()->push_back(new MapBlock(culta,"CULTA18",10,10,MT_DEFAULT));
	...
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE00",10,10,MT_LANDINGZONE));
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE01",10,10,MT_LANDINGZONE));
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE02",10,10,MT_LANDINGZONE));
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE03",10,10,MT_DEFAULT));
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE04",10,10,MT_DEFAULT));
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE05",10,10,MT_DEFAULT));
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE06",10,10,MT_DEFAULT));
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE07",10,10,MT_DEFAULT));
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE08",10,10,MT_DEFAULT));
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE09",10,10,MT_DEFAULT));
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE10",10,10,MT_DEFAULT));
	jungle->getMapBlocks()->push_back(new MapBlock(jungle,"JUNGLE11",10,10,MT_DEFAULT));
	...
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST00",10,10,MT_LANDINGZONE));
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST01",10,10,MT_LANDINGZONE));
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST02",10,10,MT_DEFAULT));
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST03",10,10,MT_DEFAULT));
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST04",10,10,MT_DEFAULT));
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST05",10,10,MT_DEFAULT));
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST06",10,10,MT_DEFAULT));
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST07",10,10,MT_DEFAULT));
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST08",10,10,MT_DEFAULT));
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST09",10,10,MT_DEFAULT));
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST10",20,20,MT_DEFAULT));
	forest->getMapBlocks()->push_back(new MapBlock(forest,"FOREST11",20,20,MT_DEFAULT));
	...
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT00",10,10,MT_LANDINGZONE));
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT01",10,10,MT_LANDINGZONE));
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT02",10,10,MT_LANDINGZONE));
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT03",10,10,MT_DEFAULT));
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT04",10,10,MT_DEFAULT));
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT05",10,10,MT_DEFAULT));
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT06",10,10,MT_DEFAULT));
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT07",10,10,MT_DEFAULT));
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT08",10,10,MT_DEFAULT));
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT09",20,20,MT_DEFAULT));
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT10",20,20,MT_DEFAULT));
	desert->getMapBlocks()->push_back(new MapBlock(desert,"DESERT11",20,20,MT_DEFAULT));
	...
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT00",10,10,MT_LANDINGZONE));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT01",10,10,MT_LANDINGZONE));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT02",10,10,MT_LANDINGZONE));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT03",10,10,MT_DEFAULT));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT04",10,10,MT_DEFAULT));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT05",10,10,MT_DEFAULT));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT06",10,10,MT_DEFAULT));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT07",10,10,MT_DEFAULT));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT08",10,10,MT_DEFAULT));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT09",10,10,MT_DEFAULT));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT10",10,10,MT_DEFAULT));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT11",20,20,MT_DEFAULT));
	mount->getMapBlocks()->push_back(new MapBlock(mount,"MOUNT12",20,20,MT_DEFAULT));
	...
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR00",10,10,MT_LANDINGZONE));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR01",10,10,MT_LANDINGZONE));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR02",10,10,MT_LANDINGZONE));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR03",10,10,MT_DEFAULT));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR04",10,10,MT_DEFAULT));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR05",10,10,MT_DEFAULT));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR06",10,10,MT_DEFAULT));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR07",10,10,MT_DEFAULT));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR08",10,10,MT_DEFAULT));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR09",10,10,MT_DEFAULT));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR10",10,10,MT_DEFAULT));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR11",10,10,MT_DEFAULT));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR12",20,20,MT_DEFAULT));
	polar->getMapBlocks()->push_back(new MapBlock(polar,"POLAR13",20,20,MT_DEFAULT));
	...
	mars->getMapBlocks()->push_back(new MapBlock(mars,"MARS00",10,10,MT_LANDINGZONE));
	...
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN00",10,10,MT_EWROAD));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN01",10,10,MT_NSROAD));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN02",10,10,MT_CROSSING));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN03",10,10,MT_LANDINGZONE));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN04",10,10,MT_LANDINGZONE));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN05",20,20,MT_DEFAULT));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN06",20,20,MT_DEFAULT));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN07",20,20,MT_DEFAULT));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN08",20,20,MT_DEFAULT));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN09",20,20,MT_DEFAULT));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN14",10,10,MT_DEFAULT));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN15",10,10,MT_DEFAULT));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN16",10,10,MT_DEFAULT));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN17",10,10,MT_DEFAULT));
	urban->getMapBlocks()->push_back(new MapBlock(urban,"URBAN18",10,10,MT_DEFAULT));

	RuleTerrain *xbase = new RuleTerrain("XBASE");
	xbase->getMapDataSets()->push_back(getMapDataSet("BLANKS"));
	xbase->getMapDataSets()->push_back(getMapDataSet("XBASE1"));
	xbase->getMapDataSets()->push_back(getMapDataSet("XBASE2"));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_00",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_01",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_02",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_03",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_04",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_05",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_06",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_07",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_08",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_09",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_10",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_11",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_12",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_13",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_14",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_15",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_16",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_17",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_18",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_19",10,10,MT_DEFAULT));
	xbase->getMapBlocks()->push_back(new MapBlock(urban,"XBASE_20",10,10,MT_DIRT));
	...
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_00",20,20,MT_UBASECOMM));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_01",20,20,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_02",20,20,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_03",20,20,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_04",10,10,MT_XCOMSPAWN));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_05",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_06",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_07",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_08",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_09",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_10",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_11",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_12",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_13",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_14",10,10,MT_DEFAULT));
	ubase->getMapBlocks()->push_back(new MapBlock(urban,"UBASE_15",20,20,MT_FINALCOMM));
	...
	_terrains.insert(std::pair<std::string, RuleTerrain*>("XBASE",xbase));
	_terrains.insert(std::pair<std::string, RuleTerrain*>("UBASE",ubase));

	// Add armor
	Armor *coveralls = new Armor("STR_NONE_UC", "XCOM_0.PCK", 0, MT_WALK);
	coveralls->setArmor(12, 8, 5, 2);
	coveralls->setCorpseItem("STR_CORPSE");

	Armor *personalArmor = new Armor("STR_PERSONAL_ARMOR_UC", "XCOM_1.PCK", 0);
	personalArmor->setArmor(50, 40, 40, 30);

	Armor *powerSuit = new Armor("STR_POWER_SUIT_UC", "XCOM_2.PCK", 0);
	powerSuit->setArmor(100, 80, 70, 60);

	Armor *flyingSuit = new Armor("STR_FLYING_SUIT_UC", "XCOM_2.PCK", 0, MT_FLY);
	flyingSuit->setArmor(110, 90, 80, 70);

	Armor *sectoidSoldierArmor = new Armor("SECTOID_ARMOR0", "SECTOID.PCK", 0);
	sectoidSoldierArmor->setArmor(4, 3, 2, 2);
	sectoidSoldierArmor->setCorpseItem("STR_SECTOID_CORPSE");

	Armor *floaterSoldierArmor = new Armor("FLOATER_ARMOR0", "FLOATER.PCK", 1, MT_FLY);
	...
	_armors.insert(std::pair<std::string, Armor*>("STR_POWER_SUIT_UC" ,powerSuit));
	_armors.insert(std::pair<std::string, Armor*>("STR_FLYING_SUIT_UC", flyingSuit));
	_armors.insert(std::pair<std::string, Armor*>("SECTOID_ARMOR0", sectoidSoldierArmor));
	...
	Unit *sectoidSoldier = new Unit("SECTOID_SOLDIER", "STR_SECTOID", "STR_LIVE_SOLDIER");
	...
	Unit *floaterSoldier = new Unit("FLOATER_SOLDIER", "STR_FLOATER", "STR_LIVE_SOLDIER");
	...
	*/
	...
	AlienRace *arSectoid = new AlienRace("STR_SECTOID");
	...
	arSectoid->addMember("CYBERDISC");
	AlienRace *arFloater = new AlienRace("STR_FLOATER");
	...
	arFloater->addMember("REAPER");
	_alienRaces.insert(std::pair<std::string, AlienRace*>("STR_SECTOID", arSectoid));
	_alienRaces.insert(std::pair<std::string, AlienRace*>("STR_FLOATER", arFloater));
