...
public:
	...
	ProductionCompleteState(Game *game, Base *base, const std::wstring &item, GeoscapeState *state, bool showGotoBaseButton, productionProgress_e endType = PROGRESS_COMPLETE);
