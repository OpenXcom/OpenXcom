 ...
 */
NewPossibleResearchState::NewPossibleResearchState(Game * game, Base * base, const std::vector<RuleResearch *> & possibilities, bool showResearchButton) : State (game), _base(base)
{
	_screen = false;
