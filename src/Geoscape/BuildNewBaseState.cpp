...
{
	_mousex = (int)floor(action->getRelativeXMouse());
	_mousey = (int)floor(action->getRelativeYMouse());
...
{
	double lon, lat;
	int mouseX = (int)action->getRelativeXMouse(), mouseY = (int)action->getRelativeYMouse();
