...
MonthlyCostsState::MonthlyCostsState(Game *game, Base *base) : State(game), _base(base)
{
	...
	_txtQuantity = new Text(game->getResourcePack()->getFont("BIGLETS.DAT"), game->getResourcePack()->getFont("SMALLSET.DAT"), 55, 9, 195, 32);
	_txtTotal = new Text(game->getResourcePack()->getFont("BIGLETS.DAT"), game->getResourcePack()->getFont("SMALLSET.DAT"), 60, 9, 250, 32);
	_txtRental = new Text(game->getResourcePack()->getFont("BIGLETS.DAT"), game->getResourcePack()->getFont("SMALLSET.DAT"), 80, 9, 10, 48);
	_txtSalaries = new Text(game->getResourcePack()->getFont("BIGLETS.DAT"), game->getResourcePack()->getFont("SMALLSET.DAT"), 80, 9, 10, 80);
	_txtIncome = new Text(game->getResourcePack()->getFont("BIGLETS.DAT"), game->getResourcePack()->getFont("SMALLSET.DAT"), 100, 9, 10, 136);
	_lstCrafts = new TextList(game->getResourcePack()->getFont("BIGLETS.DAT"), game->getResourcePack()->getFont("SMALLSET.DAT"), 300, 20, 10, 56);
	_lstSalaries = new TextList(game->getResourcePack()->getFont("BIGLETS.DAT"), game->getResourcePack()->getFont("SMALLSET.DAT"), 300, 30, 10, 88);
	_lstMaintenance = new TextList(game->getResourcePack()->getFont("BIGLETS.DAT"), game->getResourcePack()->getFont("SMALLSET.DAT"), 300, 9, 10, 120);
	_lstTotal = new TextList(game->getResourcePack()->getFont("BIGLETS.DAT"), game->getResourcePack()->getFont("SMALLSET.DAT"), 100, 9, 205, 136);
	...
	_lstMaintenance->addRow(0, 2, _game->getResourcePack()->getLanguage()->getString(STR_BASE_MAINTENANCE).c_str(), Text::formatFunding(_base->getFacilityMaintenance()).c_str());
	...
	_lstTotal->addRow(0, 2, _game->getResourcePack()->getLanguage()->getString(STR_TOTAL).c_str(), Text::formatFunding(_base->getMonthlyMaintenace()).c_str());
}
